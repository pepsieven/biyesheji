...
public class TxAdviceInterceptor {
    ...
    private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.pepsi.resources_share.service.impl.*.*(..))";
    /**
     * 配置多个切入点表达式
     */
    // private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.pepsi.resources_share.service.impl.*.*(..))" +
    ...
    public TransactionInterceptor txAdvice() {
        ...
        定义事务的隔离级别PROPAGATION_NOT_SUPPORTED事务传播级别5，
        以非事务运行，如果当前存在事务，则把当前事务挂 */
